    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteCompanyModalLabel{{ $company->id }}">Delete Confirmation</h5>
            ...
            <div class="modal-footer">
                ...
                <form id="deleteCompanyForm{{ $company->id }}" method="POST" action="/mainpage/{{ $company->id }}" class="d-inline">
                    @method('delete')
                    @csrf
